...
function createProduct(product) {
  return {
    id: product.id,
    name: product.name ? product.name : 'Имя не известно',
    price: product.price ? product.price : null,
    imgSrc: product.imgSrc ? product.imgSrc : 'ссылка на др. карт',
  };
}
...
function renderGoods() {
  ...
  for (let i = 0; i < GOODS.length; i++) {
    ...
    //рисуем кнопку в корзину в зависимости есть ли цена
